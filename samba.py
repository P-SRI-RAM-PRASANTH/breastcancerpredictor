...
#loading saved model
loaded_model=pickle.load(open("C:/Users/ppras/Downloads/classification_model.sav",'rb'))
...
def main():
         ...
         if st.button('BreasrcancerTestResult'):
              diagnosis=Breast_cancer_pedicition([mean_radius,mean_texture,mean_perimeter,mean_area,mean_smoothness])
